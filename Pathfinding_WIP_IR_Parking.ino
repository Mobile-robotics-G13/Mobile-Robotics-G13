...
void handleIntersection() {
  ...
  // === SPECIFIC TRIGGER FOR NODE 7 -> 5 ===
  if (currentNode == "7" && targetNode == "5") {
    Serial.println(">>> DESTINATION REACHED: Node 7 to 5. Entering Parking Mode.");
    moveForward(cruiseSpeed, cruiseSpeed);
    delay(400); 
    FindParking(); 
    return; 
  ...
  Serial.println(currentNode);
} // <--- FINAL CLOSING BRACKET FOR handleIntersection
